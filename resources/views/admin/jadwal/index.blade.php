                            ...
                            @foreach ($registrations as $registration)
                                <tr class="text-center bg-gray-800 border-b border-gray-700">
                                    ...
                                    <td class="py-2 px-4">
                                        ...
                                        -
                                        {{ $registration->schedules->firstWhere('scheduleName', 'Test Tulis')->room ?? '' }}
                                    </td>
                                    <td class="py-2 px-4">
                                        ...
                                        -
                                        {{ $registration->schedules->firstWhere('scheduleName', 'Wawancara Asisten')->room ?? '' }}
                                    </td>
                                    <td class="py-2 px-4">
                                        ...
                                        -
                                        {{ $registration->schedules->firstWhere('scheduleName', 'Wawancara Dosen')->room ?? '' }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
